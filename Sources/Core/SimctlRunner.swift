...
public struct SimctlRunner: Sendable {
    ...
    /// - Returns: The result containing exit code and output.
    public func boot(udid: String) async throws(SimctlError) -> SimctlResult {
    ...
    /// - Returns: The result containing exit code and output.
    public func shutdown(udid: String) async throws(SimctlError) -> SimctlResult {
    ...
    /// - Returns: The result containing exit code and output.
    public func erase(udid: String) async throws(SimctlError) -> SimctlResult {
    ...
    ///
    /// - Returns: The result containing exit code and output.
    public func eraseAll() async throws(SimctlError) -> SimctlResult {
    ...
    /// - Returns: The result containing exit code and output.
    public func install(udid: String, appPath: String) async throws(SimctlError) -> SimctlResult {
    ...
    ///   - url: The URL to open.
    /// - Returns: The result containing exit code and output.
    public func openURL(udid: String, url: String) async throws(SimctlError) -> SimctlResult {
    ...
    /// - Returns: The result containing exit code and output.
    public func clearLocation(udid: String) async throws(SimctlError) -> SimctlResult {
