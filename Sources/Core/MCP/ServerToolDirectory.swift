...
public enum ServerToolDirectory {
    ...
    private static let projectTools: [String] = [
        ...
        "set_test_plan_target_enabled", "set_test_plan_skipped_tags",
        "set_test_plan_skipped_tests", "set_test_plan_target_parallelizable",
        "set_test_plan_options", "add_test_plan_to_scheme",
        "remove_test_plan_from_scheme", "set_scheme_storekit_config", "add_storekit_config",
        "list_test_plans",
        "set_test_target_application", "rename_group",
        "add_dependency", "list_dependencies", "remove_dependency",
        "set_build_setting", "remove_build_setting", "add_framework", "remove_framework",
        "remove_subproject",
        "list_frameworks_phase",
        "set_framework_merge_attribute",
        "add_build_phase",
        "duplicate_target", "add_swift_package", "update_swift_package", "add_package_product",
        "list_swift_packages", "audit_swift_packages", "resolve_packages",
        "show_package_resolution", "remove_swift_package", "list_groups",
    ...
    private static let swiftTools: [String] = [
        ...
        "swift_diagnostics", "swift_package_docs", "swift_format", "swift_lint",
        "detect_unused_code", "swift_symbols",
