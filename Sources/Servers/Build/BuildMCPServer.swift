...
///
/// This focused server provides tools for macOS builds, project discovery, and general utilities
/// like clean and scaffolding.
///
/// ## Token Efficiency
///
/// This server exposes the tools `ToolRegistry` marks with `ServerSet.build`. Selecting a focused
...
public struct BuildMCPServer: Sendable {
    ...
    public func run() async throws {
        let server = Server(name: "xc-build", version: "1.0.0", capabilities: .init(tools: .init()))
