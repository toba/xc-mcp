...
/// ## Token Efficiency
///
/// This server exposes the 37 tools `ToolRegistry` marks with `ServerSet.debug`. Selecting a
...
public struct DebugMCPServer: Sendable {
    ...
    public func run() async throws {
        ...
        await installRegistryToolHandlers(on: server, as: .debug, deps: ToolDeps(basePath: basePath))
