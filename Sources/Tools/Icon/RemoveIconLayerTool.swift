...
public struct RemoveIconLayerTool: Sendable {
    ...
    public func tool() -> Tool {
        .init(
            ...
            description: "Remove a layer or entire group from a .icon bundle. "
            ...
            inputSchema: .object([
                ...
                "required": .array([
                    .string("bundle_path"), .string("target"), .string("group_index"),
                ]),
            ]),
    ...
    public func execute(arguments: [String: Value]) throws -> CallTool.Result {
        ...
        let purgeAssets = arguments.getBool("purge_assets", default: true)
        ...
        switch target {
            ...
            case "layer":
                ...
                removedDescription =
                    "layer \(layerIndex) \"\(layer.name)\" from group \(groupIndex)"
