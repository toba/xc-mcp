...
public struct AddIconLayerTool: Sendable {
    ...
    public func tool() -> Tool {
        .init(
            name: "add_icon_layer",
            description: "Add a new image layer to an existing .icon bundle. "
            ...
            inputSchema: .object([
                ...
                "properties": .object([
                    ...
                    "opacity": .object([
                        "type": .string("number"),
                        "description": .string(
                            "Layer opacity 0.0–1.0 (default: not set, full opacity)."),
                    ]),
                    "blend_mode": .object([
                        "type": .string("string"),
                        "description": .string(
                    ...
                    "glass": .object([
                        "type": .string("boolean"),
                        "description": .string(
                            "Enable glass effect on this layer (default: true)."),
                    ]),
                ]),
    ...
    public func execute(arguments: [String: Value]) throws -> CallTool.Result {
        ...
        let glass = arguments.getBool("glass", default: true)
        ...
        let target = createGroup
            ...
            : "group \(groupIndex)"
        return CallTool.Result.text("Added layer \"\(name)\" (\(imageFilename)) to \(target)")
    }
}
