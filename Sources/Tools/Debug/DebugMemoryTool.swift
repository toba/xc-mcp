...
public struct DebugMemoryTool: Sendable {
    ...
    public func tool() -> Tool {
        .init(
            name: "debug_memory",
            description: "Read memory at an address in a debugged process.",
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "pid": .object([
                    ...
                    "count": .object([
                        "type": .string("integer"),
                        "description": .string("Number of items to read. Defaults to 16."),
                    ]),
                    "format": .object([
                        "type": .string("string"),
                        "description": .string(
                    ...
                    "size": .object([
                        "type": .string("integer"),
                        "description": .string("Item size in bytes: 1, 2, 4, or 8. Defaults to 4."),
                    ]),
                ]),
