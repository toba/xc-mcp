...
public struct SetBuildSettingTool: Sendable {
  ...
  public func execute(arguments: [String: Value]) throws -> CallTool.Result {
    guard case .string(let projectPath) = arguments["project_path"],
      ...
      case .string(let configuration) = arguments["configuration"],
      case .string(let settingName) = arguments["setting_name"],
      case .string(let settingValue) = arguments["setting_value"]
    else {
