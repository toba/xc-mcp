...
public struct DuplicateTargetTool: Sendable {
  ...
  public func execute(arguments: [String: Value]) throws -> CallTool.Result {
    guard case .string(let projectPath) = arguments["project_path"],
      case .string(let sourceTargetName) = arguments["source_target"],
      case .string(let newTargetName) = arguments["new_target_name"]
    else {
    ...
    if case .string(let bundleId) = arguments["new_bundle_identifier"] {
