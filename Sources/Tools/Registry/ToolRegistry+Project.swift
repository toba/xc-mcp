...
extension ToolRegistry {
    ...
    static let project1: [ToolRegistration] = [
        ...
        ToolRegistration("add_synchronized_folder_exception", .project, [.monolith, .project]) {
            deps in
            let tool = AddSynchronizedFolderExceptionTool(pathUtility: deps.paths)
            return (tool.tool(), { try tool.execute(arguments: $0.arguments) })
        },
        ToolRegistration(
            "add_synchronized_folder_phase_membership", .project, [.monolith, .project]
        ) { deps in
        ...
        ToolRegistration("add_target_to_synchronized_folder", .project, [.monolith, .project]) {
            deps in
        ...
        ToolRegistration("list_synchronized_folder_exceptions", .project, [.monolith, .project]) {
            deps in
    ...
    static let project2: [ToolRegistration] = [
        ...
        ToolRegistration("remove_synchronized_folder_exception", .project, [.monolith, .project]) {
            deps in
        ...
        ToolRegistration("remove_target_from_synchronized_folder", .project, [.monolith, .project])
        { deps in
        ...
        ToolRegistration("set_platform_filters", .project, [.monolith, .project]) { deps in
            let tool = SetPlatformFiltersTool(pathUtility: deps.paths)
            return (tool.tool(), { try tool.execute(arguments: $0.arguments) })
        },
        ToolRegistration("set_product_name", .project, [.monolith, .project]) { deps in
            let tool = SetProductNameTool(pathUtility: deps.paths)
            return (tool.tool(), { try tool.execute(arguments: $0.arguments) })
        },
    ...
    static let project3: [ToolRegistration] = [
        ...
        ToolRegistration("set_test_plan_target_parallelizable", .project, [.monolith, .project]) {
            deps in
