...
public struct ScaffoldIOSProjectTool: Sendable {
    ...
    public func tool() -> Tool {
        Tool(
            ...
            description:
            "Create a new iOS project with a modern workspace + Swift Package Manager architecture. The app source folder is a synchronized root group (Xcode 16+), so files dropped on disk are picked up automatically — no add_file needed.",
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "project_name": .object([
