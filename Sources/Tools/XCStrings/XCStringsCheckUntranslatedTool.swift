...
///
/// Ported from Ryu0118/xcstrings-crud PR #33 (`feature/check-untranslated-hooks`). Returns
/// structured `UntranslatedIssue` rows with a `reason` enum so callers can distinguish missing keys
/// from empty values, `needs_review` state, partial plural/device variation coverage, etc. — gaps
/// that the existing `xcstrings_list_untranslated` tool silently misses.
